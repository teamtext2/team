...
const appData = [
    ...
    { id: 13, name: "File", description: "File management (in development).", icon: "https://file.text2.pro/apple-touch-icon.png", url: "https://file.text2.pro" },
    { id: 14, name: "Create Img", description: "Create images (in development).", icon: "https://team.text2.pro/app/create-img/apple-touch-icon.png", url: "https://team.text2.pro/app/create-img/" },
...
const researchAppData = [
    { id: 1, name: "Create Image", description: "Create images (Team).", icon: "https://team.text2.pro/app/create-img/apple-touch-icon.png", url: "https://team.text2.pro/app/create-img" },
    { id: 2, name: "Image Compression", description: "Compress image file size.", icon: "https://team.text2.pro/app/compy/apple-touch-icon.png", url: "https://team.text2.pro/app/compy" },
    { id: 3, name: "TTS", description: "Convert text to speech.", icon: "https://team.text2.pro/app/tts/apple-touch-icon.png", url: "https://team.text2.pro/app/tts" },
];
